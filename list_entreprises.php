...
<header>
    ...
    <a href="index.php"><h1>Control Tech</h1></a>
    <a href="">Listes clients</a>
    <a href="add_client.php">Creer Clients</a>
    <a href="list_entreprises.php">Listes Entreprise</a>
    <a href="add_entreprise.php">Creer Entreprise</a>
    <a href="list_factures.php">Listes Factures</a>
    <a href="create_facture.php">Creer Factures</a>
...
<div class="container">
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="add_entreprise.php">
